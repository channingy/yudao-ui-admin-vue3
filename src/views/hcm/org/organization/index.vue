  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="负责人工号" prop="leaderEmpNo">
        <el-input
          v-model="queryParams.leaderEmpNo"
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['hcm:organization:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['hcm:organization:export']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['hcm:organization:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['hcm:organization:delete']"
          >
            删除
          </el-button>
        </template>
